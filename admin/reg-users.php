...
<head>
    ...
    <title>Plastic Management System: Reg Users</title>
...
{               ?>
                         <td><?php echo htmlentities($cnt);?></td>
                                        ...
                                        <td>
                                               <a href="user-lodged-complain.php?uid=<?php echo htmlentities ($row->ID);?>&&username=<?php echo htmlentities ($row->FullName);?>" class="btn btn-primary">View Lodged Request</a>
                                        </td>
                        </tr>
                        <?php $cnt=$cnt+1;}} ?>
                      </tbody>
