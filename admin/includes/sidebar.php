...
{               ?>
            ...
            <ul id="main-menu" class="metismenu">
                ...
                <li>
                    <a href="" class="has-arrow"><i class="ti-folder"></i><span>Create Bin Point</span></a>
                    <ul>
               ...
               <li>
                    <a href="javascript:void(0)" class="has-arrow"><i class="ti-files"></i><span>Request</span></a>
                    <ul>
                        <li><a href="all-complain.php">All Request</a></li>
                        <li><a href="new-complain.php">New Request</a></li>
                        <li><a href="assign-complain.php">Assign Request</a></li>
                        <li><a href="rejected-complain.php">Rejected Request</a></li>
                    </ul>
                </li>
                <li>
