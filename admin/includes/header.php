...
<nav class="navbar custom-navbar navbar-expand-lg py-2">
    <div class="container-fluid px-0">
        ...
        <a href="dashboard.php" class="navbar-brand"><strong>Plastic Management System</strong></a>
        <div id="navbar_main">
...
?>
                            ...
                            <h5 class="heading h6 mb-0">Request Notifications <span class="badge badge-pill badge-primary text-uppercase float-right"><?php echo $totalreq;?></span></h5>
                        </div>
